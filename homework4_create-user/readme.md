...
1. Опишите своими словами, что такое метод обьекта
   ...
   Об'єкт - це набір властивостей, і кожна властивість складається з імені та значення, асоційованого з цим ім'ям. Значення властивості може бути функція, її можна назвати методом об'єкта
